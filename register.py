...
frame_alpr = tk.LabelFrame(root, text=" --Register-- ", width=600, height=800, bd=5, font=('times', 14, ' bold '),fg="black",bg="#A0522D")
frame_alpr.grid(row=0, column=0, sticky='nw')
...
def insert():
    ...
    if (fname.isdigit() or (fname == "")):
        ...
        with conn:
            cursor = conn.cursor()
            cursor.execute(
                'INSERT INTO registration(Fullname, address, Email, PhoneNo,var, age, username, password) VALUES(?,?,?,?,?,?,?,?)',
...
l1 = tk.Label(frame_alpr, text="__Registration Form__", font=("Times new roman", 30, "bold","italic"),bd=5, bg="#A0522D", fg="white")
l1.place(x=120, y=10)
